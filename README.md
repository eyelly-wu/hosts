...
* [GitHub Actions](https://github.com/features/actions)：定时任务，每24小时自动更新 hosts
...
```text
# github hosts generated by hosts-generator on 2026-07-02 08:59:30
...
# 更有效的方案
hosts 方案仅能缓解部分 DNS 污染问题，稳定性有限。如需稳定访问 `Google`、`Youtube`、`X`、`OpenAI` 等外网服务，推荐使用梯子。[如何科学上网 →](https://github.com/eyelly-wu/vpn)