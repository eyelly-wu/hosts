...
* [Vercel Serverless Functions](https://vercel.com/docs/concepts/functions/serverless-functions)：部署了函数接口，即使 `GitHub` 不能访问也能获取到最新的hosts文件
...
```text
# github hosts generated by hosts-generator on 2022-12-02 20:59:30
